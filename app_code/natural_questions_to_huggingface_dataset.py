...
BATCH_SIZE = 10_000
DEFAULT_NATURAL_QUESTIONS_DATASET = "speakleash/natural-questions-pl"
...
def main(
    ...
    try:
        ...
        print(
            f"Loading Natural Questions from private dataset: {natural_questions_dataset} ({natural_questions_split})"
        )
