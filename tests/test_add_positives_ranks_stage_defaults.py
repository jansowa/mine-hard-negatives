...
def test_positive_ranks_candidate_stage_uses_candidate_env(monkeypatch):
    ...
    monkeypatch.setenv("CANDIDATE_POSITIVE_RANKS_RERANKER_NAME", "small-reranker")
    monkeypatch.setenv("CANDIDATE_POSITIVE_RANKS_RERANKER_BATCH_SIZE", "17")
...
def test_positive_ranks_final_stage_uses_final_env(monkeypatch):
    ...
    monkeypatch.setenv("FINAL_POSITIVE_RANKS_RERANKER_NAME", "large-reranker")
    monkeypatch.setenv("FINAL_POSITIVE_RANKS_RERANKER_BATCH_SIZE", "5")
